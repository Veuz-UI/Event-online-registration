...
<body>
    ...
    <div class="background-all">
        <div class="container">
            ...
            <div class="cermonies" data-aos="fade-up">
                <h1>Veuz Appreciation ceremonies</h1>
            </div>
            ...
            <div class="book-btn-2 d-flex justify-content-center" data-aos="fade-up">
                <a href="ticket.php"><button class="book-btn">Book Ticket</button></a>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4" data-aos="fade-up">
                            <div class="view-box1">
                                <div class="gif1">
                                    <img src="images/our-speakers.gif" alt="" class="img-fluid">

                                </div>
                                <h2>Our Speakers</h2>
                                <h4>Exciting speakers to follow at the event</h4>
                                <a href="speaker.php"> <button class="view-spkr">View Speakers</button></a>
                            </div>
                        </div>
                        <div class="col-lg-4" data-aos="fade-up" data-aos-duration="700">
                            <div class="view-box1">
                                <div class="gif2">
                                    <img src="images/clndr.gif" alt="" class="img-fluid">
                                </div>
                                <h2>Featured Sessions</h2>
                                <h4>Exciting speakers to follow at the event</h4>
                                <a href="agenda.php"><button class="view-spkr">View Agenda</button></a>
                            </div>
                        </div>
                        <div class="col-lg-4" data-aos="fade-up" data-aos-duration="1200">
                            <div class="view-box1">
                                <div class="gif3">
                                    <img src="images/ticket.gif" alt="" class="img-fluid">
                                </div>
                                <h2>Tickets</h2>
                                <h4>Exciting speakers to follow at the event</h4>
                                <a href="ticket.php"><button class="view-spkr">View Tickets</button></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6" data-aos="fade-right">
                        <div class="venue">
                                ...
                                <div class="row d-flex align-items-center">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="whr-cntnt">
                                            ...
                                            <h5 class="address">28/1650D, Cyberpark Kozhikode Park Road, Nellikkode, Kozhikode, Kozhikode, Kerala 673016 India</h5>
                                        </div>
                            ...
                            <div class="map-main">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3913.0981768178704!2d75.8344504117973!3d11.254187850151101!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba65b946032ba75%3A0xf5ed91156d32a4f2!2sCyberpark%20Kozhikode!5e0!3m2!1sen!2sin!4v1694498260442!5m2!1sen!2sin"
                        ...
                        <div class="get-in">
                            <form id="contact" action="" method="post">
                                ...
                                <fieldset>
                                    ...
                                    <input placeholder="Enter your last name" type="email">
                                </fieldset>
                                <fieldset>
                                    <label for="">Email Address</label>
                                    <input placeholder="Enter your email address" type="tel">
                                </fieldset>
                                <fieldset>
                                    <label for="">Mobile</label>
                                    <input placeholder="Enter your mobile number" type="url" required>
                                </fieldset>
                                <fieldset>
                                    <label for="">Address</label>
                                    <textarea placeholder="Enter your mobile address" tabindex="5" required></textarea>
                                </fieldset>
                                <fieldset>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ygbV9kiqUc6oa4msXn9868pTtWMgiQaeYH7/t7LECLbyPA2x65Kgf80OJFdroafW" crossorigin="anonymous">
    </script>
